...
const Header = () => {
  ...
  return (
    <div className="w-full h-[80px] flex justify-between items-center bg-black px-4 fixed z-40">
      <Link
        to="/"
        className="w-[100px] h-full bg-red-300 flex justify-center items-center"
      ></Link>
      <div className="hidden md:flex gap-5 items-center">
        ...
        <Link to="/register-form" className="text-white text-lg font-medium">
          Register Process
        </Link>
        ...
        {/* <Link to="/logout" className="text-white text-lg font-medium">
          Logout
        </Link> */}
      </div>
